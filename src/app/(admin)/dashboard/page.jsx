...
export default function DashboardPage() {
    return (<div>
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
        <DashboardCard title="Receita Total" value="$12,345" icon={<DollarSign className="h-4 w-4 text-muted-foreground"/>} description="+20,1% em relação ao mês passado"/>
        <DashboardCard title="Total de Estudantes" value="1.250" icon={<Users className="h-4 w-4 text-muted-foreground"/>} description="+180,1% em relação ao mês passado"/>
        <DashboardCard title="Cursos" value="25" icon={<Book className="h-4 w-4 text-muted-foreground"/>} description="+5 em relação ao mês passado"/>
        <DashboardCard title="Visualizações" value="150.000" icon={<BarChart className="h-4 w-4 text-muted-foreground"/>} description="+12,5% em relação ao mês passado"/>
      </div>
